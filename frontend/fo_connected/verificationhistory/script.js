var rejected = [
  { biz: 'Tech Solutions Ltd',    person: 'Sarah Johnson',  appId: 'TL-2024-0156',
    submitted: 'Feb 15, 2024', rejectedOn: 'Feb 20, 2024',
    reason: 'Business Affidavit document is incomplete and Aadhar card copy is unclear.',
    boxColor: 'box-red' },
  { biz: 'Fresh Bites Restaurant',person: 'Michael Chen',   appId: 'TL-2024-0142',
    submitted: 'Feb 10, 2024', rejectedOn: 'Feb 16, 2024',
    reason: 'Aadhar card number does not match the name provided in application form.',
    boxColor: 'box-orange' },
  { biz: 'Elite Fitness Center',  person: 'David Martinez', appId: 'TL-2024-0128',
    submitted: 'Feb 5, 2024', rejectedOn: 'Feb 10, 2024',
