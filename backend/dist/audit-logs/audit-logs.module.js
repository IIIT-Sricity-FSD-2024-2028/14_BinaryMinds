...
const audit_logs_repository_1 = require("./audit-logs.repository");
...
exports.AuditLogsModule = AuditLogsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [audit_logs_repository_1.AuditLogsRepository, audit_logs_service_1.AuditLogsService],
