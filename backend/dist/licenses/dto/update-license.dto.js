...
class UpdateLicenseDto extends (0, swagger_1.PartialType)(create_license_dto_1.CreateLicenseDto) {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: false, enum: require("../../common/enums/license-status.enum").LicenseStatus } };
    }
}
exports.UpdateLicenseDto = UpdateLicenseDto;
__decorate([
    (0, class_validator_1.IsEnum)(license_status_enum_1.LicenseStatus),
